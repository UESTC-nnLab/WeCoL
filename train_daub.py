...
from utils.dataloader_for_DAUB import seqDataset, dataset_collate_train, dataset_collate_val, seqValDataset
from utils.utils import get_classes, show_config
from utils.utils_fit import fit_one_epoch

# os.environ["CUDA_VISIBLE_DEVICES"] = "0" ###使用显卡0
'''
...
if __name__ == "__main__":
    ...
    #---------------------------------------------------------------------#
    classes_path    = '/home/dww/OD/two_stream2/model_data/classes.txt'
    #----------------------------------------------------------------------------------------------------------------------------#
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/home/dww/OD/two_stream2/model_data/yolox_s.pth'
    # model_path      = ''
    #------------------------------------------------------#
    ...
    train_annotation_path ='/home/dww/OD/weak_stream5/pseudo_gt/pse_DAUB_train.txt' ### pseudo_label 
    val_annotation_path = '/home/public/DAUB/coco_val_DAUB.txt'

    ##ITSDT
    # DATA_PATH = "/home/public/ITSDT/"
    # # train_annotation_path = '/home/public/DAUB/coco_train_DAUB.txt'
    # train_annotation_path ='/home/dww/OD/weak_stream5/pseudo_gt/pse_ITSDT_train.txt' ### pseudo_label 
    # val_annotation_path = '/home/public/ITSDT/coco_val_ITSDT.txt'

    ##IRDST
    # DATA_PATH = "/home/public/IRDST/real/"
    # train_annotation_path ='/home/dww/OD/weak_stream5/pseudo_gt/pse_IRDST_train.txt' ### pseudo_label
    ...
    if True:
        ...
        train_dataset = seqDataset(train_annotation_path, input_shape[0], 5)
        val_dataset = seqValDataset(val_annotation_path, input_shape[0], 5)
        ...
        gen             = DataLoader(train_dataset, shuffle = shuffle, batch_size = batch_size, num_workers = num_workers, pin_memory=True,
                                    drop_last=True, collate_fn=dataset_collate_train, sampler=train_sampler)
        gen_val         = DataLoader(val_dataset  , shuffle = shuffle, batch_size = batch_size, num_workers = num_workers, pin_memory=True, 
                                    drop_last=True, collate_fn=dataset_collate_val, sampler=val_sampler)
